...
const int rs = PA1, en = PA2, d4 = PA4, d5 = PA5, d6 = PA6, d7 = PA7;
const int backlight_pin = PA0;  // Note: pulling 30mA while on
...
byte rowPins[4] = { PB3, PB4, PB5, PB6 };
...
// global vars
// init screen (inits LCD 4-bit mode; see docs)
...
/* input window
   ...
   Returns TODO
    ...
    -2: failure
*/
int input_window(const char* buf, int bufsize,
