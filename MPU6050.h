...
//   double ang_speed = sqrt( pow ( ((double) accel_t_gyro.value.x_gyro) / 10000 , 2 ) +
//                         pow ( ((double) accel_t_gyro.value.y_gyro) / 10000 , 2 ) +
//                         pow ( ((double) accel_t_gyro.value.z_gyro) / 10000 , 2 ) );
